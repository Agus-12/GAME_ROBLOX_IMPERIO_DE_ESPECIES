# 📋 COPIAR Y PEGAR LOS 5 ARCHIVOS (ronda v38)
...
Hay un archivo llamado **`v38-ARCHIVOS.html`** (vive en el workspace, no en el repo) que
...
> **`RONDA: v38`**: la que lo tenga es la buena. (Los 5 archivos traen ese sello arriba.)
...
> el texto `MI_VERSION = "v38"`. Los viejos no. (Y si borras el bueno por error, no pasa
