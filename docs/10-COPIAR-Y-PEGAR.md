# 📋 COPIAR Y PEGAR LOS 5 ARCHIVOS (ronda v36)
...
Hay un archivo llamado **`v36-ARCHIVOS.html`** (vive en el workspace, no en el repo) que
...
> **`RONDA: v36`**: la que lo tenga es la buena. (Los 5 archivos traen ese sello arriba.)
...
> el texto `MI_VERSION = "v36"`. Los viejos no. (Y si borras el bueno por error, no pasa
