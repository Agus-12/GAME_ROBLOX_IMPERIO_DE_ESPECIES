# 📋 COPIAR Y PEGAR LOS 5 ARCHIVOS (ronda v30)
...
Hay un archivo llamado **`v30-ARCHIVOS.html`** (vive en el workspace, no en el repo) que
...
> el texto `MI_VERSION = "v30"`. Los viejos no. (Y si borras el bueno por error, no pasa
